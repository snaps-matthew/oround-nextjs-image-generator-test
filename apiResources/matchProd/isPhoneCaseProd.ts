...
export const isUVPrintPhoneCase = (productCode:string) => {
  ...
  productCode === PRODUCT_CODE.PHONE_CASE_FANCY_IPHONE_13 ||
  productCode === PRODUCT_CODE.PHONE_CASE_UV_IPHONE_13_PRO ||
  productCode === PRODUCT_CODE.PHONE_CASE_FANCY_IPHONE_13_PRO ||
  productCode === PRODUCT_CODE.PHONE_CASE_UV_IPHONE_13_MINI ||
  productCode === PRODUCT_CODE.PHONE_CASE_FANCY_IPHONE_13_MINI ||
  productCode === PRODUCT_CODE.PHONE_CASE_UV_IPHONE_13_PRO_MAX ||
  productCode === PRODUCT_CODE.PHONE_CASE_FANCY_IPHONE_13_PRO_MAX
  )
}
